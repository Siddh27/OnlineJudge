...
import { addProblem, addSubmission, deleteProblem, getAllProblems, getProblem, getProblemAuthor, runProblem, updateProblem } from "../controllers/problem.controllers.js";
const router = Router()
...
router.route('/addSubmission').post(verifyJWT,addSubmission)
router.route('/getProblemAuthor').post(verifyJWT,getProblemAuthor)
