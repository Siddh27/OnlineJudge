    ...
    <>
      ...
      <div className='text-center text-2xl p-3 font-bold text-white italic'>
        ...
        <div className="flex w-full justify-around">
            <div className="py-5">
                <Link to={'../updateProfile'}><button type="button" className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-md px-5 py-2.5 text-center">Update</button></Link>
            </div>
            <div className=" py-5">
                <Link to={'../changePassword'}><button type="button" className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-md px-5 py-2.5 text-center">ChangePassword</button></Link>
            </div>
        </div>
      </div>
    </>
